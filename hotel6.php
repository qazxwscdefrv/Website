...
<html lang="en">
<head>
  <title>Roda Al Murooj Hotel</title>
  <meta charset="utf-8">
...
<h1 class="names"> Roda Al Murooj Hotel </h1>
    <br>

    
    <div id="slides">
	
	<div class="slide showing img-rounded"><img class="img-rounded" src="images/H6.jpg" width="1135" height="470" ></div>
    <div class="slide "> <img  class="img-rounded" src="images/H6.2.jpg"  width="1130" height="470" ></div> 
    <div class="slide "> <img  class="img-rounded" src="images/H6.1.jpg" width="1132" height="470"></div> 
    <div class="slide "> <img  class="img-rounded" src="images/H6.3.jpg"  width="1132" height="470" ></div> 
    </div>
   <br>
    <br> <br>
    <br>
...
pauseButton.onclick = function(){
  ...
  <hr>
<div class="container tt"> <h1 class="names text-center">Roda Al Murooj Hotel </h1>
    <div class="t text-center"><p>Boasting a swimming pool, a Jacuzzi and outdoor tennis courts, Roda Al Murooj Hotel is located in Dubai and offers luxury accommodation. It provides 5-star accommodation with air-conditioned rooms. 
    </p>
    <p>Guests can enjoy the hotel's relaxation amenities, such as a beauty centre and a sauna, and work out at Flow Health Club and Wellness. Guests can also enjoy free private parking on site. 
    </p>
    <p>The luxurious feel of each room at Roda Al Murooj Hotel is complemented by amenities like slippers, mini bars and flat-screen TVs. All provide a telephone, a DVD player and a seating area. 
        </p>
    <p>On-site dining options include Pergolas and Tabule, which both serve dinner. There is also the added convenience of an in-house restaurant and pub. 
  </p></div>
 <!--body-->
<div class="container">    
  <div class="row">
    <div class="col-sm-4">
     <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r6.1.jpg" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r6.2.jpg" class="img-responsive"  alt="Image"></div>
    ...
    <div class="col-sm-4"> 
       <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r6.3.jpg" class="img-responsive"  alt="Image"></div>
...
<div class="container">    
  <div class="row">
    <div class="col-sm-4">
      <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r6.4.jpg" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r6.5.jpg" class="img-responsive"  alt="Image"></div>
    ...
    <div class="col-sm-4"> 
     <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r6.6.jpg" class="img-responsive" s alt="Image"></div>

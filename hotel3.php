...
<html lang="en">
<head>
  <title>JA Ocean View Hotel</title>
  <meta charset="utf-8">
...
<h1 class="names"> JA Ocean View Hotel </h1>
    <br>

    
    <div id="slides">
	
	<div class="slide showing img-rounded"><img class="img-rounded" src="images/H3.2.jpg" width="1135" height="470" ></div>
    <div class="slide "> <img  class="img-rounded" src="images/H3.1.jpg" width="1132" height="470"></div> 
    <div class="slide "> <img  class="img-rounded" src="images/H3.3.jpg"  width="1132" height="470" ></div> 
    </div>
   <br>
    <br> <br>
    <br>
...
pauseButton.onclick = function(){
  ...
  <hr>
<div class="container tt"> <h1 class="names text-center">JA Ocean View Hotel </h1>
...
<div class="container">    
  <div class="row">
    ...
    <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r3.1.jpg" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r3.2.jpg" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r3.3.jpg" class="img-responsive"  alt="Image"></div>
...
<div class="container">    
  <div class="row">
    <div class="col-sm-4">
     <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r3.4.png" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r3.5.png" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r3.6.jpg" class="img-responsive" s alt="Image"></div>

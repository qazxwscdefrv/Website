...
<h1 class="names"> Dusit Thani </h1>
    <br>

    
    <div id="slides">
	
	<div class="slide showing img-rounded"><img class="img-rounded" src="images/H4.jpg" width="1135" height="470" ></div>
    <div class="slide "> <img  class="img-rounded" src="images/H4.2.jpg"  width="1130" height="470" ></div> 
    <div class="slide "> <img  class="img-rounded" src="images/H4.1.jpg" width="1132" height="470"></div> 
    <div class="slide "> <img  class="img-rounded" src="images/H4.3.jpg"  width="1132" height="470" ></div> 
    </div>
   <br>
    <br> <br>
    <br>
...
pauseButton.onclick = function(){
  ...
  <hr>
<div class="container tt"> <h1 class="names text-center">Dusit Thani </h1>
    <p>Featuring a rooftop pool and a limousine service, Dusit Thani is a luxurious place to stay in Dubai. It also offers a Jacuzzi, free Wi-Fi and a free shuttle service.  
    </p>
    <p>This modern hotel provides an executive floor, a beauty centre and valet parking. Multilingual staff can assist with reservations or dining recommendations, and an express check-in facility is offered for convenience. 

    </p>
    <p>Rooms are air-conditioned and have top-of-the-range amenities such as slippers and a mini bar. They feature a telephone, a bathtub and an alarm clock. 

        </p>
    <p>TDubai's well-known attractions are within close proximity to Dusit Thani, with 21st Century Tower and Liberty House only a 10-minute stroll away. Burj Khalifa and The Index are a short car ride away.  </p></div>
   <!--body-->
<div class="container">    
  <div class="row">
    <div class="col-sm-4">
       <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r4.1.jpg" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r4.2.jpg" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r4.3.jpg" class="img-responsive"  alt="Image"></div>
...
<div class="container">    
  <div class="row">
   ...
   <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r4.4.jpg" class="img-responsive"  alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r4.5.jpg" class="img-responsive"  alt="Image"></div>
  ...
  <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r4.6.jpg" class="img-responsive" s alt="Image"></div>

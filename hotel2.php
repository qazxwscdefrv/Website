...
<html lang="en">
<head>
  <title>First Central Hotel Apartments</title>
  <meta charset="utf-8">
...
<h1 class="names"> First Central Hotel Apartments </h1>
    <br>

    
    <div id="slides">
	
	<div class="slide showing img-rounded"><img class="img-rounded" src="images/H2.1.jpg" width="1135" height="470" ></div>
    <div class="slide "> <img  class="img-rounded" src="images/H2.2.jpg"  width="1130" height="470" ></div> 
    <div class="slide "> <img  class="img-rounded" src="images/H2.1.jpg" width="1132" height="470"></div> 
    <div class="slide "> <img  class="img-rounded" src="images/H2.4.jpg"  width="1132" height="470" ></div> 
    </div>
   <br>
    <br> <br>
    <br>
...
pauseButton.onclick = function(){
  ...
  <hr>
<div class="container tt"> <h1 class="names text-center">First Central Hotel Apartments </h1>
    <p>Situated in Dubai, First Central Hotel Apartments provides 4-star accommodation, as well as a rooftop pool. It offers complimentary Wi-Fi, a free shuttle service and fitness classes. 
    </p>
    <p>The property has panoramic city views, plus a coffee bar, facial treatments and a beauty centre. Guests can also enjoy free private parking on site. 
    </p>
    <p>First Central Hotel Apartments has air conditioned apartments with a marble bathroom, luxury toiletries and slippers. All offer a refrigerator, a flat-screen TV and bottled water.  
        </p>
    <p>Guests staying at First Central Hotel Apartments can sit down to a unique dining experience at the on-site restaurant, conveniently based for those who want to stay close at mealtime. </p>
    </div><!--body-->
<div class="container">    
  <div class="row">
    <div class="col-sm-4">
    <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r2.1.jpg" class="img-responsive"  alt="Image"></div>
    ...
    <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r2.5.jpg" class="img-responsive"  alt="Image"></div>
    ...
    <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r2.3.jpg" class="img-responsive"  alt="Image"></div>
...
<div class="container">    
  <div class="row">
    ...
    <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r2.4.jpg" class="img-responsive"  alt="Image"></div>
    ...
    <div class="col-sm-4"> 
     <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r2.2.jpg" class="img-responsive"  alt="Image"></div>
    ...
    <div class="panel " style="background-color: #DF433B;"> 
        ...
        <div class="panel-title"><img src="images/r2.6.jpg" class="img-responsive" s alt="Image"></div>
